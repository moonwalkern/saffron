    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset id="account">
          ...
          <div class="form-group required" style="display: <?php echo (count($customer_groups) > 1 ? 'block' : 'none'); ?>;">
            ...
            <div class="col-sm-10">
              ...
              <?php if ($customer_group['customer_group_id'] == $customer_group_id) { ?>c:\Users\sg178b\Sreeji\ATT\Payment\AddWirelinePayment.png.zip\
              <div class="radio">
                <label>
        ...
        <fieldset id="address">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-zip"><?php echo $entry_zip; ?></label>
            <div class="col-sm-10">
              <input type="text" name="zip" value="<?php echo $zip; ?>" placeholder="<?php echo $entry_zip; ?>" id="input-zip" class="form-control" />
              <input type="hidden" name="zipaddress" value="<?php echo $input-address; ?>" id="input-address" />
              <?php if ($error_zip) { ?>
...
$(document).ready(function(){
      ...
      $("input[name=\'zipaddress\']").on("change", function() {
          var a = $(this).val();
            //console.log(a);
            var aArray = a.split(",");
            $('input[name=\'zip\']').val(aArray[4]);
            $('input[name=\'address_1\']').val(aArray[1]);
            $('input[name=\'address_2\']').val(aArray[2]);
            $.ajax({
				url: 'index.php?route=account/account/zip&zip_id=' + aArray[4],
				dataType: 'json',
				beforeSend: function() {
					$('input[name=\'zip\']').after(' <i class="fa fa-circle-o-notch fa-spin"></i>');
				},
				complete: function() {
					$('.fa-spin').remove();
				},
...
var $element = $(this);
		...
		$.ajax({
			url: 'index.php?route=account/account/zip&zip_id=' + this.value,
			dataType: 'json',
			beforeSend: function() {
				$('input[name=\'zip\']').after(' <i class="fa fa-circle-o-notch fa-spin"></i>');
			},
			...
			if(json['zone_id']){
				...
				var building = $('input[name=\'company\']').val();
				var address1 = $('input[name=\'address_1\']').val();
				var city = json['city'];
				var state = json['state'];
				console.log(zip);
				console.log('index.php?route=common/streetvalidate&target=input-address&building='+building+'&address1='+address1+'&city='+city+'&state='+state+'&zip='+zip);
		
			$.ajax({
					url: 'index.php?route=common/streetvalidate&target=input-address&building='+building+'&address1='+address1+'&city='+city+'&state='+state+'&zip='+zip,
					dataType: 'html',
					beforeSend: function() {
...
$('input[name=\'zip\']:checked').trigger('change');
//--></script>
<script type="text/javascript"><!--
