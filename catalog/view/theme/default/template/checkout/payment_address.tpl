<form class="form-horizontal">
  ...
  <div id="payment-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
    ...
    <div class="form-group required">
      <label class="col-sm-2 control-label" for="input-shipping-zip"><?php echo $entry_zip; ?></label>
      <div class="col-sm-10">
        <input type="text" name="zip" value="" placeholder="<?php echo $entry_zip; ?>" id="input-zip" class="form-control" />
